...
/**
 * Projection of the total {@link com.smartfinance.backend.gastos.model.entity.Expense} amount grouped by
 ...
 * unclassified (see {@link com.smartfinance.backend.gastos.model.entity.Expense#getCategory()}); callers must
