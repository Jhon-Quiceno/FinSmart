...
import com.smartfinance.backend.exception.AiProviderAuthException;
import com.smartfinance.backend.exception.AiProviderException;
import com.smartfinance.backend.exception.AiProviderModelNotFoundException;
import com.smartfinance.backend.exception.AiProviderRateLimitException;
import com.smartfinance.backend.exception.AiProviderTimeoutException;
import com.smartfinance.backend.exception.AiProviderUnavailableException;
 ...
 * {@link RestClient.Builder} bean (see {@code com.smartfinance.backend.config.RestClientConfig})
...
public class AiChatClient {
     ...
     * client — so it triggers {@link com.smartfinance.backend.service.ai.AiChatOrchestrator}'s
