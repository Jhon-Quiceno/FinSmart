...
/**
 * Payload to create or update an {@link com.smartfinance.backend.model.Expense}.
 *
 * <p>{@link #date} uses {@link PastOrPresent} for the same reasoning as
 * {@link com.smartfinance.backend.dto.income.IncomeRequest#date()}: this sprint models
