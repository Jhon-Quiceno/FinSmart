package com.smartfinance.backend.servicios.exception;
 ...
 * duplicate {@link com.smartfinance.backend.gastos.model.entity.Expense} and advance {@code nextPaymentDate}
