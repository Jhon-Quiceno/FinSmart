...
public interface RecurringPaymentRepository extends JpaRepository<RecurringPayment, Long> {
    ...
    /**
     * Used by {@code com.smartfinance.backend.ia.service.ai.FinancialContextBuilder} to list the
     ...
     * would otherwise create a duplicate {@link com.smartfinance.backend.gastos.model.entity.Expense}.
     *
