...
const ICON_COLOR_MUTED = 'rgb(94 100 108)';
    ...
    <SafeAreaView className="flex-1 bg-background">
      ...
      >
        <View className="mb-8 items-center gap-2">
          <View className="h-14 w-14 items-center justify-center rounded-2xl border border-primary/30 bg-primary/20">
            <Text className="text-2xl font-bold text-primary">K</Text>
          </View>
        ...
        <View className="rounded-xl border border-border bg-card p-5">
          ...
          <Text className="mt-5 text-center text-sm text-muted-foreground">
            ¿No tenés una cuenta?{' '}
            <Text className="font-medium text-primary">Registrate gratis</Text>
          </Text>
        </View>

        <Link href="/" className="mt-6 text-center text-sm text-muted-foreground">
          Volver
        </Link>
      </ScrollView>
    </SafeAreaView>
